...
template <class T>
QuickSort<T>::QuickSort() // Total: O(2n+1)
{
    topIndex = -1; // O(1)
...
template <class T>
void QuickSort<T>::addItem(T newValue) // Total (worst case): O(4n+4)
{
    int insertIndex = 0;
...
template <class T>
void QuickSort<T>::deleteItem(T deleteData) // Total (worst case): O(6n+4) 
{
...
template <class T>
void QuickSort<T>::printList() // Total (worst case): O(2n)
{
